...
package tests.createAnnotation.equalsHashCodeToString
...
fun box(): String {
    ...
    val a1 = createA.call()
    if (a1.toString() != "@tests.createAnnotation.equalsHashCodeToString.A()") return "Fail: toString does not correspond to the documentation of java.lang.annotation.Annotation#toString: $a1"
    ...
    if (b1.toString() != "@tests.createAnnotation.equalsHashCodeToString.B(s=1)") return "Fail: toString does not correspond to the documentation of java.lang.annotation.Annotation#toString: $b1"
