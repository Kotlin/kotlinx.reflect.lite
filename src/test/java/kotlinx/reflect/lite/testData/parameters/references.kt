...
fun box(): String {
    val cFoo = (C::class.java).kotlinClass.getMemberByName("foo")
    val cBar = (C::class.java).kotlinClass.getMemberByName("bar") as KMutableProperty1<C, String>
    val cExtFun = Class.forName("tests.parameters.references.ReferencesKt").kotlinClass.getMemberByName("extFun")
